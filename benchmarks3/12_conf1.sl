...
(define-fun inv-f ((conf_0 Int) (x Int) (y Int) (tmp Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (x_0 Int) (x_1 Int) (x_2 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (and
 (or (not (and (= y_1 0) (= x_1 20)))
  (not (and (= conf_0 conf_0_1) (= x x_1) (= y y_1))))
 (>= y 0)))
