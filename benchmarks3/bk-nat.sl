...
(define-fun inv_fun ((invalid Int) (unowned Int) (nonexclusive Int) (exclusive Int) (RETURN Int)) Bool (or (and (>= unowned 0) (>= nonexclusive 0) (>= exclusive 0) (>= invalid 0) (>= (+ invalid unowned exclusive) 1) (= RETURN 0)) (= RETURN 1)))
