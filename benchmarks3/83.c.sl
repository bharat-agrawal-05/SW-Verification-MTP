...
(define-fun inv-f ((x Int) (y Int) (x_0 Int) (x_1 Int) (x_2 Int) (x_3 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (or (and (= x x_1) (= x_1 (- 5000))) (not (and (= x x_2) (= y y_1) (not (or (< x_2 0) (> y_1 0)))))))
