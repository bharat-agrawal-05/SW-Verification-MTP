...
(define-fun inv-f ((i Int) (size Int) (sn Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (size_0 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int)) Bool (or (and (= sn 0) (= i 1)) (and (<= 1 i) (<= i size) (= (- i 1) sn)) (and (> i size) (= sn size) (not (= sn 0)))))
