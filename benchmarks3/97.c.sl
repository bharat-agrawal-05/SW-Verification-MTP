...
(define-fun inv-f ((i Int) (j Int) (x Int) (y Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (x_0 Int) (y_0 Int) (y_1 Int)) Bool (or (and (= i 0) (= j 0) (= x 2) (= y 0)) (and (<= 0 i) (<= 0 j) (<= 0 y) (or (not (= y 1)) (= i j)))))
