...
(define-fun inv-f ((a Int) (c Int) (j Int) (k Int) (m Int) (a_0 Int) (c_0 Int) (j_0 Int) (j_1 Int) (k_0 Int) (k_1 Int) (k_2 Int) (k_3 Int) (m_0 Int) (m_1 Int) (m_2 Int) (m_3 Int)) Bool (or (< k c) (and (>= k c) (>= m a)) (and (> j 0) (= m (- a 1)) (< k c)) (and (> j 0) (>= m a) (> k c) (= k (- c 1)))))
