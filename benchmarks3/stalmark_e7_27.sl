...
(define-fun str_invariant ((top.usr.OK Bool) (top.res.init_flag Bool) (top.impl.usr.a Bool) (top.impl.usr.b Bool) (top.impl.usr.c Bool)) Bool (and (or (and top.impl.usr.a (not top.impl.usr.b) (not top.impl.usr.c)) (and (not top.impl.usr.a) top.impl.usr.b (not top.impl.usr.c)) (and (not top.impl.usr.a) (not top.impl.usr.b) top.impl.usr.c)) (not (and top.impl.usr.a top.impl.usr.b top.impl.usr.c)) (= top.usr.OK (not (and top.impl.usr.a top.impl.usr.b top.impl.usr.c)))))
