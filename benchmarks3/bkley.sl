...
(define-fun post_fun ((invalid Int) (unowned Int) (nonexclusive Int) (exclusive Int) (RETURN Int)) Bool
    (=> (= RETURN 0) (and (>= exclusive 0) (>= unowned 0) (>= (+ invalid unowned exclusive nonexclusive) 1))))

;; Verified Ground Truth Inductive Invariant
;; Source: NeuralInvariantRanker (Chakraborty et al.) -- verified positive invariant
(define-fun inv_fun ((invalid Int) (unowned Int) (nonexclusive Int) (exclusive Int) (RETURN Int)) Bool (=> (= RETURN 0) (and (>= exclusive 0) (>= unowned 0) (>= (+ invalid unowned exclusive nonexclusive) 1))))
