...
(define-fun inv-f ((i Int) (n Int) (sn Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (n_0 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int)) Bool (and
 (or (not (and (= i i_2) (= n n_0) (= sn sn_2)))
