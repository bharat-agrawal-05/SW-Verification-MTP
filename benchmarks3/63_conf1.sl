...
(define-fun inv-f ((conf_0 Int) (x Int) (y Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (x_0 Int) (x_1 Int) (x_2 Int) (x_3 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (or (and (= conf_0_0 4) (= x_1 1) (= conf_0 conf_0_1) (= x x_2) (= y y_1) (<= x_2 10) (>= y_1 0) (= y_2 (- 10 x_2)) (= conf_0_2 (- 469 conf_0_1)) (= x_3 (+ x_2 1)) (= conf_0_3 (+ 687 622))) (not (and (= conf_0 conf_0_1) (= x x_2) (= y y_1) (not (<= x_2 10)) (not (>= y_1 0))))))
