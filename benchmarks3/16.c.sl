...
(define-fun inv-f ((m Int) (n Int) (x Int) (tmp Int) (m_0 Int) (m_1 Int) (m_2 Int) (m_3 Int) (n_0 Int) (x_0 Int) (x_1 Int) (x_2 Int)) Bool (or (and (= m 0) (= x 0)) (and (>= m 0) (> n 0) (>= x 0) (<= x n) (>= (+ x (* m n)) 0))))
