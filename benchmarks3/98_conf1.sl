...
(define-fun inv-f ((i Int) (j Int) (conf_0 Int) (x Int) (y Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (x_0 Int) (y_0 Int) (y_1 Int)) Bool (and (>= y 0) (or (= y 2) (and (= i 0) (= j 0) (= conf_0 0) (= x x_0) (= y y_1) (not (<= i_2 x_0)) (not (= i_2 j_2)) (not (not (= y_1 1)))))))
