...
(define-fun trans_fun ((i Int) (j Int) (k Int) (m Int) (n Int) (x Int) (y Int) (i! Int) (j! Int) (k! Int) (m! Int) (n! Int) (x! Int) (y! Int)) Bool
...
(define-fun inv_fun ((i Int) (j Int) (k Int) (m Int) (n Int) (x Int) (y Int)) Bool (and (or (<= n 0) (and (<= 0 m) (not (<= n m)))) (= k (+ x y)) (>= j 0)))
