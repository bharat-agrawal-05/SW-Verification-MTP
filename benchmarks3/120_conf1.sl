...
(define-fun inv-f ((i Int) (conf_0 Int) (sn Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int)) Bool (and (<= 0 i) (<= i 9) (<= 0 sn) (<= sn 8) (= sn (- i 1)) (<= conf_0 370)))
