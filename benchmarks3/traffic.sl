...
(define-fun str_invariant ((top.usr.Delta Int) (top.usr.OK Bool) (top.res.init_flag Bool) (top.res.abs_0 Int) (top.res.abs_1 Bool) (top.res.abs_2 Bool) (top.res.inst_1 Bool) (top.res.inst_0 Bool)) Bool
 (and (=> top.res.abs_2 (and (<= 0 top.res.abs_0) (<= top.res.abs_0 20)))
 (= top.res.abs_1 (and (<= (- 1) top.usr.Delta) (<= top.usr.Delta 1)))
 (= top.usr.OK (=> top.res.abs_2 (and (<= 0 top.res.abs_0) (<= top.res.abs_0 20))))))
