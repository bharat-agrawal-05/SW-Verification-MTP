...
(define-fun inv-f ((i Int) (conf_0 Int) (n Int) (sn Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (n_0 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int)) Bool (and
 (or (not (and (= i i_2) (= conf_0 conf_0_1) (= n n_0) (= sn sn_2)))
  (not (and (not (<= i_2 n_0)) (not (= sn_2 0)) (not (= sn_2 n_0)))))
 (= sn (+ -1 i))))
