...
(define-fun inv-f ((conf_0 Int) (x Int) (y Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (x_0 Int) (x_1 Int) (x_2 Int) (x_3 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (or (and (= conf_0 3) (= x (- 15000))) (not (and (= conf_0 conf_0_1) (= x x_2) (= y y_1))) (not (and (not (< x_2 0)) (not (> y_1 0))))))
