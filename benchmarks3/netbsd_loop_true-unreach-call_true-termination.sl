...
(define-fun InvF ((MAXPATHLEN Int) (pathbuf_off Int) (bound_off Int) (glob2_p_off Int) (glob2_pathbuf_off Int) (glob2_pathlim_off Int)) Bool (and (> MAXPATHLEN 0) (< MAXPATHLEN 2147483647) (= pathbuf_off 0) (= bound_off (- (+ pathbuf_off (+ MAXPATHLEN 1)) 1)) (<= 0 glob2_p_off) (<= glob2_p_off (+ MAXPATHLEN 1)) (<= glob2_p_off glob2_pathlim_off) (<= glob2_pathlim_off bound_off) (= glob2_pathbuf_off pathbuf_off) (= glob2_p_off glob2_pathbuf_off) (= glob2_pathlim_off (- (+ pathbuf_off (+ MAXPATHLEN 1)) 1)) )
)
