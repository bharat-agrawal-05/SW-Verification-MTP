...
(define-fun trans-f ((x Int) (y Int) (i Int) (k Int) (x! Int) (y! Int) (i! Int) (k! Int)) Bool
    (and (< i k) (= k! k) (= i! (+ i 1)) (= y! (+ y 1)) (= x! (+ x (* y! y! y!)))))
(define-fun post-f ((x Int) (y Int) (i Int) (k Int)) Bool
    (or (< i k) (and (= y k) (= (* 4 x) (+ (+ (* 2 (* (* y y) y)) (* y y)) (* (* y y) (* y y)))))))

;; Verified Ground Truth Inductive Invariant
;; Source: NeuralInvariantRanker (Chakraborty et al.) -- verified positive invariant
(define-fun inv-f ((x Int) (y Int) (i Int) (k Int)) Bool
 (and (>= i 0) (<= i k) (= (* 4 x) (+ (* 2 (* (* y y) y)) (* y y) (* (* y y) (* y y))))
 (= y i)))
