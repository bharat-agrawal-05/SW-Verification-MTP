...
(define-fun inv-f ((conf_0 Int) (sn Int) (x Int) (tmp Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int) (x_0 Int) (x_1 Int) (x_2 Int) (x_3 Int)) Bool (and (>= x 0) (>= sn 0) (or (and (= conf_0 3) (= sn 0) (= x 0)) (not (and (= conf_0 conf_0_1) (= sn sn_2) (= x x_2))) (not (and (not (= sn_2 x_2)) (not (= sn_2 (- 1))))))))
