...
(define-fun inv-f ((a Int) (j Int) (conf_0 Int) (k Int) (m Int) (a_0 Int) (j_0 Int) (j_1 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (conf_0_4 Int) (k_0 Int) (k_1 Int) (k_2 Int) (k_3 Int) (m_0 Int) (m_1 Int) (m_2 Int) (m_3 Int)) Bool (or (< k 1) (and (= k 1) (<= a m))))
