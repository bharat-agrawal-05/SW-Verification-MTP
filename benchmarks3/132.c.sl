...
(define-fun post-f ((c Int) (i Int) (j Int) (t Int) (tmp Int) (c_0 Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (t_0 Int) (t_1 Int) (t_2 Int) (t_3 Int)) Bool
    (or (not (and (= c c_0) (= i i_1) (= j j_1) (= t t_1))) (not (and (not (>= i_1 0))))))

;; Verified Ground Truth Inductive Invariant
;; Source: NeuralInvariantRanker (Chakraborty et al.) -- verified positive invariant
(define-fun inv-f ((c Int) (i Int) (j Int) (t Int) (tmp Int) (c_0 Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (t_0 Int) (t_1 Int) (t_2 Int) (t_3 Int)) Bool (and (>= i 0) (or (not (and (= c c_0) (= i i_1) (= j j_1) (= t t_1))) (not (and (not (>= i_1 0)))))))
