...
(define-fun inv-f ((n Int) (x Int) (y Int) (n_0 Int) (x_0 Int) (x_1 Int) (x_2 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (or (not (and (= n n_0) (= x x_1) (= y y_1))) (not (and (not (<= x_1 n_0)) (> n_0 0) (not (<= y_1 n_0))))))
