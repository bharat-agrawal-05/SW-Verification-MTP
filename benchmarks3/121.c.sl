...
(define-fun inv-f ((i Int) (sn Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (sn_0 Int) (sn_1 Int) (sn_2 Int) (sn_3 Int)) Bool (or (and (= i 1) (= sn 0)) (and (<= i 8) (<= sn i) (= (- i sn) 1)) (and (> i 8) (= sn 8))))
