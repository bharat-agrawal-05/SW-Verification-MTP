...
(define-fun inv_fun ((x1 Int) (x2 Int) (x3 Int) (v1 Int) (v2 Int) (v3 Int) (t Int) (RETURN Int)) Bool (and (<= v1 5) (>= v3 0) (<= v2 6) (>= (+ v2 6) 0) (>= (- v1 v3) 0) (>= (+ (* 5 t) 75) x2) (>= (+ (* 2 v2) (* 2 t)) (+ v1 v3)) (>= (+ x2 (* 5 t)) 75) (>= (- (+ v1 v3 (* 2 t)) (* 2 v2)) 0)))
