...
(define-fun inv-f ((conf_0 Int) (x Int) (y Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_0_3 Int) (x_0 Int) (x_1 Int) (x_2 Int) (x_3 Int) (y_0 Int) (y_1 Int) (y_2 Int)) Bool (or (and (= conf_0 conf_0_0) (= x x_1) (= conf_0_0 1) (= x_1 1)) (and (= conf_0_1 conf_0) (= x_2 x) (= y_1 y) (<= x_2 100) (= y_2 (- 100 x_2)) (= conf_0_2 575) (= x_3 (+ x_2 1)) (= conf_0_3 (+ conf_0_2 conf_0_2)) (= conf_0_3 conf_0) (= y_2 y)) (not (and (= conf_0 conf_0_1) (= x x_2) (= y y_1))) (not (and (not (<= x_2 100)) (not (< y_1 100))))))
